...
export default class Ui {
    ...
    let cards = `<div class="card card-map">
     ...
     <div class="card card-nam">
      ...
      <tr><td class="w-50">Currency</td>
        <td class="w-50"><div>${result.currencies[0].name}</div>
  ...
  static displayAbout() {
    $('.modal-title').html(`Geographical places dictionary`);
    const about = `<Header class="lead my-2">Credits</Header>
        
        <Header class="lead my-2">Credits</Header>
        <p class="text-left">Data based on:</p>
        <ul class="text-left">
        
        <li>Geo Names & weather <a href="https://www.geonames.org/" class="text-decoration-none">https://www.geonames.org</a></li>
        <li>Exchange Rates API <a href="https://exchangeratesapi.io/" class="text-decoration-none">https://exchangeratesapi.io</a></li>
        <li>Countries <a href="https://restcountries.eu/" class="text-decoration-none">https://restcountries.eu</a></li>
        </ul>`;
