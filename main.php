...
if (isset($_REQUEST['location'])){
    ...
    //api.geonames.org/weatherJSON?formatted=true&north=44.1&south=-9.9&east=-22.4&west=55.2&username=arurknul

    $weatherData = getData("http://api.geonames.org/weatherJSON?formatted=true&=north=${location}&south=${location}&east=${location}&west=${location}&username=$geonamesUsername");
    echo $weatherData;
}
