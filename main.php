...
$openCageDataApiKey = "21045c77489c49cca67f49e100ce4ee1";
...
if (isset($_REQUEST['location'])){
    ...
    $weatherData = getData("https://api.opencagedata.com/geocode/v1/json?q=${location}&key=$openCageDataApiKey&units=metric&language=en&pretty=1");
    echo $weatherData;
}
